...
for i in tqdm(test_ids):
    ...
    with torch.no_grad():
        ...
        if pred:
            comp_g_edge_mask_dict, paths = pgexplainer.explain(src_nid, tgt_nid, drug1_nid, drug2_nid, mp_g, args.num_paths, args.max_path_length)
...
if args.save_explanation:
    ...
    saved_path_explanation_file = f'pgexp_{args.saved_model_name}_pred_edge_to_paths'
